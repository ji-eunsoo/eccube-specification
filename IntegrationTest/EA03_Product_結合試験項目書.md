...
1. 商品管理 → カテゴリ管理
1. "CSVダウンロード"ボタンより"CSVダウンロード"を選択する
...
1. 商品管理 → 規格CSV登録
1. "雛形ファイルダウンロード"ボタンを押下する
1. CSVがダウンロードされる（ファイル名：class_name.csv）※ ファイルの内容は、カテゴリCSV登録に表示されている項目名が出力される
...
1. 商品管理 → 規格分類CSV登録
1. "雛形ファイルダウンロード"ボタンを押下する
1. CSVがダウンロードされる（ファイル名：class_category.csv）※ ファイルの内容は、カテゴリCSV登録に表示されている項目名が出力される
